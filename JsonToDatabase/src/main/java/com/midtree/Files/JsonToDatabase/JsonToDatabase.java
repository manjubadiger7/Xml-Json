package com.midtree.Files.JsonToDatabase;
...
public class JsonToDatabase {
	public static Connection ConnectToDB() throws Exception {
		...
		String mysqlUrl = "jdbc:mysql://localhost/xml";
	...
	public static void main(String args[]) {
		...
		try {
			...
			JSONObject jsonObject = (JSONObject) jsonParser.parse(
					new FileReader("C:/Users/M1064478/Desktop/Eclipse WorkSpaces/XML&JSON/Files/JsonToDatabse.json"));
